...
\[
\begin{array}{rl}
    \displaystyle \frac{N_D^+}{N_D^0} & \displaystyle = \frac{1}{g_d} \exp\left( \frac{E_D - E_F}{k_B T} \right) = \frac{1}{g_d} \exp\left( \frac{E_D - E_C}{k_B T} \right) \exp\left( \frac{E_C - E_F}{k_B T} \right) = \\[4pt]
...
\begin{enumerate}[label=\alph*)]
    ...
    \[
    E_{D1} - E_C = \SI{-0.01}{\eV}, \quad E_{D2} - E_C = \SI{-0.05}{\eV}, \quad E_{D3} - E_C = \SI{-0.10}{\eV}, \quad E_{D4} - E_C = \SI{-0.30}{\eV}
    \]
...
\begin{itemize}
    ...
    \[
    n_i(\SI{300}{\kelvin}) = \sqrt{(\num{1.0e19}) (\num{0.5e18})} \exp\left( -\frac{1.0}{2 \cdot 0.026} \right) = \sqrt{\num{5.0e36}} \exp(-19.2308) \approx \SI{9.94e9}{\cm^{-3}}
    \]

    \item \textbf{A $T = \SI{200}{\kelvin}$ ($k_B T = \SI{0.017}{\eV}$, $E_g = \SI{1.05}{\eV}$):}
    \[
    n_i(\SI{200}{\kelvin}) = \sqrt{(\num{0.54e19}) (\num{0.28e18})} \exp\left( -\frac{1.05}{2 \cdot 0.017} \right) = \sqrt{\num{1.512e36}} \exp(-30.8824) \approx \SI{4.76e4}{\cm^{-3}}
    \]
\end{itemize}
